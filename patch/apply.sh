...
cd $build_root
# Start
FETCH='system_sepolicy'
FETCH_BRANCH='staging/cm-14.0'
FETCH_GIT='ferhung-mtk'
FETCH_PRE='android'
FETCH_DIR=${FETCH/\_//}
FETCH_URL='https://github.com/'${FETCH_GIT}/${FETCH_PRE}_${FETCH}.git
...
# Hack for build
mkdir -p /1and/cm/out/target/product/HM2014011/obj/KERNEL_OBJ/usr

echo -e ""
echo -e ${CL_RED}"Applying patches"${CL_RST}
echo -e ${CL_RST}"----------------"${CL_RST}
patches_path="$build_root/device/Xiaomi/HM2014011/patch/"
